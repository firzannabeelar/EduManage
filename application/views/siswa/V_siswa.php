    ...
    <div class="flex" id="app">
        ...
        <div class="flex-1 p-8 space-y-6 transition-all duration-300" id="content">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?= site_url('siswa/tambah'); ?>" class="bg-blue-500 font-bold text-white p-3 rounded-md inline-block transform transition-transform duration-300 hover:scale-110 hover:bg-gradient-to-r from-blue-500 to-indigo-500">
                    ...
                    <tbody>
                        <?php $no = 1; foreach ($siswa as $s): ?>
                            <tr class="hover:bg-gradient-to-r from-blue-200 to-indigo-200">
                                ...
                                <td class="py-2 px-4">
                                    <a href="<?= site_url('siswa/edit/'.$s->nisn); ?>" class="text-blue-500 font-bold inline-block transform transition-transform duration-300 hover:scale-110">Edit</a> |
