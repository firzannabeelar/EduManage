        ...
        <div class="flex-1 p-8 space-y-6 transition-all duration-300" id="content">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                <?php foreach ($tanggal as $t): ?>
                    <a href="<?= site_url('absensi/detail_kepsek/' . $kelas_id . '/' . $t); ?>" class="bg-gradient-to-r from-indigo-600 to-blue-500 shadow-md rounded-lg p-10 text-center text-white transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <div>
