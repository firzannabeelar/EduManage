...
<body class="bg-blue-50 font-sans">
    ...
    <div class="flex justify-center items-center h-screen">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8 max-w-sm w-full space-y-6">
            ...
            <form action="<?= site_url('loginregister/login_admin'); ?>" method="POST">
                <div class="space-y-4">
                    <div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">Belum punya akun? <a href="<?= site_url('loginregister/register_admin'); ?>" class="text-blue-500 font-bold inline-block transform transition-transform duration-300 hover:scale-110">Daftar Admin</a></p>
            </div>
        </div>
    </div>
