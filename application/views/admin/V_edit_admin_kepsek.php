    ...
    <div class="bg-white text-gray-800 w-64 h-screen p-5 space-y-6 transition-all duration-300" id="sidebar">
            <ul class="space-y-4">
               <li><a href="<?= site_url('dashboard/dashboard_kepsek'); ?>" class="text-blue-500 flex items-center p-3 rounded-md text-2xl font-bold ml-3"><i class="fas fa-book-reader mr-3"></i>EduManage</a></li>
                ...
                <li><a href="<?= site_url('admin/admin_kepsek'); ?>" class="text-blue-500 flex items-center hover:bg-gradient-to-r from-blue-500 to-indigo-400 hover:text-white p-3 rounded-md"><i class="fas fa-chalkboard-teacher mr-3"></i>Pengelolaan Data Guru</a></li>
            </ul>
        </div>
            ...
            <form action="<?= site_url('admin/update_kepsek/' . $admin->id); ?>" method="POST">
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" class="p-2 border rounded-md w-full" value="<?= $admin->nama; ?>" required>
                    </div>

                    <div>
                        <label for="jabatan" class="block text-gray-800 font-bold">Jabatan</label>
                        <input type="text" name="jabatan" id="jabatan" class="p-2 border rounded-md w-full" value="<?= $admin->jabatan; ?>" required>
                    </div>

                    <div>
                        <label for="telepon" class="block text-gray-800 font-bold">Telepon</label>
                        <input type="text" name="telepon" id="telepon" class="p-2 border rounded-md w-full" value="<?= $admin->telepon; ?>" required>
                    </div>
